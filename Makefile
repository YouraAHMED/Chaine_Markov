...
test_markov: tests/test_markov.o src/markov.o src/hachage.o
	gcc tests/test_markov.o src/markov.o src/hachage.o -o tests/test_markov $(CFLAGS)
	./tests/test_markov
	rm tests/test_markov

test_repertoire: tests/test_repertoire.o src/repertoire.o src/hachage.o src/markov.o
	gcc tests/test_repertoire.o src/repertoire.o -o tests/test_repertoire src/hachage.o src/markov.o $(CFLAGS)
